...
user_name = 'user'
save_npy_path = '/mnt/d/ntu_rgb_skeleton_data/nturgb+d_npy/'
load_txt_path = '/mnt/d/ntu_rgb_skeleton_data/nturgb+d_skeletons/'
missing_file_path = './NTU_RGBD_samples_with_missing_skeletons.txt'
